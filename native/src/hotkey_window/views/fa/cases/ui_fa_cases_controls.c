    ...
    int total_rows)
{
    kbo_window_text_appendf(buffer,
        ...
        ".faCasesTable th[data-fa-sort-type]{cursor:pointer;padding-right:18px}.faCasesTable th[data-fa-sort-type]::after{content:'';position:absolute;right:6px;top:50%%;width:0;height:0;opacity:0}.faCasesTable th.sortAsc::after{margin-top:-4px;border-left:4px solid transparent;border-right:4px solid transparent;border-bottom:5px solid #dedede;opacity:.9}.faCasesTable th.sortDesc::after{margin-top:-2px;border-left:4px solid transparent;border-right:4px solid transparent;border-top:5px solid #dedede;opacity:.9}"
        ".faCasesTable .roPo{width:74px}.faCasesTable .roName{width:240px}.faCasesTable .roCase{width:190px}.faCasesTable .roGrade{width:70px}.faCasesTable .roAge{width:64px;text-align:right}.faCasesTable .roNat{width:96px}.faCasesTable .roRights{width:84px}.faCasesTable th.roAge{padding-left:5px;text-align:right}.faCasesTable th.roGrade,.faCasesTable th.roRights{text-align:left}"
        ".faCasesTable .roGrade{width:70px;overflow:visible!important}.faCasesTable td.roGrade{position:relative}.faGradeValue{display:inline-flex;align-items:center;min-width:24px;font-weight:900;color:#ffb13b}.faGradeTooltip{position:absolute;left:5px;top:24px;z-index:95;display:none;min-width:158px;padding:7px 9px;border:1px solid #454545;border-radius:3px;background:#171717;color:#f4f4f4;box-shadow:0 8px 18px rgba(0,0,0,.62);font-size:12px;font-weight:800;line-height:1.35;pointer-events:none}.faGradeTipRow{display:flex;align-items:center;justify-content:space-between;gap:14px;white-space:nowrap}.faGradeTipRow+ .faGradeTipRow{margin-top:3px}.faGradeTipLabel{color:#aaa;font-weight:800}.faGradeTipValue{color:#fff;font-weight:900}.faCasesTable .roGrade.hasHover:hover .faGradeTooltip{display:block}"
        ".faMarketMoreRow td{height:30px;text-align:center;color:#cfcfcf;background:#181818!important;border-top:1px solid #2e2e2e;font-size:12px;font-weight:900;cursor:pointer}.faMarketMoreRow td:hover{background:#22353d!important;color:#fff}"
        "</style>"
