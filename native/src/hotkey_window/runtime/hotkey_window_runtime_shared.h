...
#define KBO_WM_WEBVIEW_DISABLE        (WM_APP + 0x4b3u)
...
extern ICoreWebView2Environment* g_kbo_webview_environment;
...
extern uint32_t g_kbo_hub_selected_secondary_draft_year;
