...
void kbo_hub_ensure_valid_selection(void)
{
    ...
    if (g_kbo_hub_selected_secondary_draft_subview < 0
    ...
    if (g_kbo_hub_selected_secondary_draft_season != 0u
            && !kbo_secondary_draft_is_odd_season(g_kbo_hub_selected_secondary_draft_season)) {
        g_kbo_hub_selected_secondary_draft_season = 0u;
    }
}
