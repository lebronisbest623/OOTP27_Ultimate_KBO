...
uint8_t* resolve_patch_target_by_rva_or_masked_pattern(HMODULE exe, uint32_t rva, const uint8_t* expected, const uint8_t* expected_mask, size_t expected_size, const char* label);
...
uint8_t* resolve_patch_target_by_rva_existing_rax_or_masked_pattern(HMODULE exe, uint32_t rva, const uint8_t* expected, const uint8_t* expected_mask, size_t expected_size, const char* label);
