...
#define KBO_RUNTIME_MAX_TEAM_VECTOR_COUNT 10000
#define KBO_RUNTIME_MAX_EVENT_VECTOR_COUNT 20000
#define KBO_RUNTIME_MAX_PLAYER_VECTOR_COUNT 200000
#define KBO_RUNTIME_PLAUSIBLE_CONTEXT_ID_MAX 100000u
#define KBO_RUNTIME_PLAUSIBLE_TEAM_ID_MAX 1000000u
#define KBO_RUNTIME_PLAUSIBLE_PLAYER_ID_MAX 1000000u
