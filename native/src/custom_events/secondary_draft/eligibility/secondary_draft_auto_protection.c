...
int kbo_secondary_draft_auto_submit_team_protection_list(
    uint32_t season,
    ...
    int* out_written)
{
    ...
    if (season == 0u || team == NULL || team->team_id == 0u || team_index < 0
    ...
    if (kbo_secondary_draft_sql_team_submitted(season, team->team_id, NULL)) {
        return 0;
    }
    ...
    const char* source)
{
    ...
    for (int team_index = 0; team_index < team_count; team_index++) {
        ...
        int written = 0;
        if (!kbo_secondary_draft_auto_submit_team_protection_list(
                season,
                team,
                team_index,
                candidates,
