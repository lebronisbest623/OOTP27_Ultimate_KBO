...
$GeneratedFiles = @(
    ...
    @{ Path = "build_verify/build_abi.generated.h"; Suggestion = "Run tools/generate-supported-builds.ps1." },
    @{ Path = "build_verify/build_abi.generated.c"; Suggestion = "Run tools/generate-supported-builds.ps1." },
